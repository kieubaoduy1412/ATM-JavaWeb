...
<link href="${pageContext.request.contextPath}/resources/css/addMoney.css" rel="stylesheet">
...
<body>
	<div class="contentAddMoney">
		<div class="bankTitle"><h1>PAY IN MONEY</h1></div>
		...
		<div class="box">
			<div class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-2 col-sm-offset-3 control-label"
						for="txtReceiver">Amount (VND)</label>
					<div class="col-xs-12 col-sm-2">
				...
				<div class="listButton">
					<div class="btn-group ">
						<div class="col-xs-12 col-sm-3"><a onclick='addFunction();'><button class="btn btn-primary" type="button">Agree</button></a> </div>
